  ...
  this.formConfig = {
    options: {
      fieldSets: {
        ...
        aboutYou: {
          'label': 'Sobre el propietario del negocio'
        },
        industry: {
          'label': 'Industria'
        },
    ...
    fields: {
      purpose: {
        purpose: {
          type: String,
          required: true,
          label: '¿Para qué utilizarás el financiamiento?',
          choiceOther: true,
        ...
        moneyInvested: {
          type: String,
          label: '¿Cual es el monto de tu inversión?',
      ...
      industry: {
        businessType: {
          ...
          tooltip: 'Algunos programas son específicos para ciertos tipos',
        ...
        industry: {
          ...
          tooltip: 'Si estuvieras incorporado, elige la industria seleccionada durante el registro de la Corporación en el Departamento de Estado.',
      ...
      location: {
        businessLocation: {
          ...
          tooltip: 'Elige el o los municipios en donde se encuentra tu negocio. Si aún no tienes una ubicación, selecciona los municipios que te interesen.',
          widget: 'multiSelect',
      ...
      sizeOfBusiness: {
        ...
        yearsInBusiness: {
          type: String,
          required: true,
          label: '¿Cuál es la antigüedad de tu negocio?',
          tooltip: 'Selecciona el número desde que te has incorporado en el Departamento de Estado.',
          widget: 'radio',
        ...
        annualRevenue: {
          type: String,
          required: true,
          label: '¿Cuál es tu ganancia anual?',
          tooltip: 'Puedes seleccionar el último año activo.',
          widget: 'radio',
